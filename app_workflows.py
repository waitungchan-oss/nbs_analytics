...
def _load_fast_export_artifacts(cache: dict, manifest_path: str | Path) -> bool:
    ...
    cache.update(
        ...
        export_fast_reference_status=str((manifest.reference or {}).get("status", "UNKNOWN")),
        export_fast_deep_diff_skipped=bool((manifest.reference or {}).get("deep_diff_skipped", False)),
        export_fast_equivalence_status=str(manifest.equivalence_status),
...
def _load_and_compute_cache(include_ai: bool = True) -> None:
    ...
    st.session_state["PROCESSED_DATA_CACHE"] = {
        ...
        "ex_beta": None,
        "ex_no_writeoff_beta": None,
        "ex_no_writeoff_refund_transfer_beta": None,
        "anm": pd.DataFrame(),
        "t": analysis_tour,
        "o": analysis_others,
