...
def _render_run_details(
    ...
    *,
    ...
    render_governance_graph_workspace(
        run, query_graph=query_graph, lineage_lookup=lineage_lookup, catalog_lookup=catalog_lookup, management_summary_lookup=management_summary_lookup, streamlit_module=st,
    )
...
def render_agent_operations(
    ...
    *,
    ...
    if not runs:
        ...
        _render_run_details(selected, query_graph=query_graph, lineage_lookup=lineage_lookup, catalog_lookup=catalog_lookup, management_summary_lookup=management_summary_lookup)
    else:
