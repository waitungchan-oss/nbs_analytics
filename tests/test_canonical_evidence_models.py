...
def _task_gate_payload(**overrides):
    ...
    payload["contractFingerprint"] = overrides.get("contractFingerprint", CanonicalEvidenceRegistry().for_kind("task_gate").contract_fingerprint)
...
def _terra_payload(**overrides):
    ...
    payload.update(overrides)
    payload["contractFingerprint"] = overrides.get("contractFingerprint", CanonicalEvidenceRegistry().for_kind("terra_diagnosis").contract_fingerprint)
    payload["evidenceFingerprint"] = _sha256_without_evidence_fingerprint(payload)
    return payload
...
def _incident_payload(**overrides):
    ...
    payload.update(overrides)
    payload["contractFingerprint"] = overrides.get("contractFingerprint", CanonicalEvidenceRegistry().for_kind("protected_incident").contract_fingerprint)
    payload["evidenceFingerprint"] = _sha256_without_evidence_fingerprint(payload)
    return payload
...
def test_evidence_fingerprint_and_registry_contract_binding_fail_closed_when_tampered():
